  ...
  return (
    <div className="max-w-6xl mx-auto p-8 space-y-8">
      ...
      <div className="flex items-center gap-3 text-sm text-accent">
        ...
        <span>/</span>
        <span className="text-secondary font-medium">Book Appointment</span>
      </div>

      {/* Header */}
      <h1 className="text-2xl font-semibold text-secondary">Book Appointment</h1>
      ...
      <button
        ...
        className="w-full bg-primary text-white py-4 rounded-xl text-lg hover:bg-primary-dark transition"
      >
        Confirm Appointment
      </button>
    </div>
